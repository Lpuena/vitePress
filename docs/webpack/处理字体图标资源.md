...
<html lang="en">
  ...
  <body>
    ...
    <div class="box5"></div>
    <!-- 使用字体图标 --> // [!code ++]
    <i class="iconfont icon-arrow-down"></i> // [!code ++]
    <i class="iconfont icon-ashbin"></i> // [!code ++]
    <i class="iconfont icon-browse"></i> // [!code ++]
  ...
  module: {
    rules: [
      ...
      {  // [!code ++]
        ...
        generator: { // [!code ++]
          filename: "static/media/[hash:8][ext][query]", // [!code ++]
        }, // [!code ++]
      },
    ],
  },
...
```
:::tip `type:"asset/resource"` 和 `type:"asset"` 的区别：
